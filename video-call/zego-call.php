...
<body>
    ...
    <script>
        ...
        const ROOM_DETAIL_URL = './api/video-room-detail.php';
        const ROOM_ACCESS_URL = './api/video-room-access.php';
        const ROOM_PRESENCE_URL = './api/video-room-presence.php';
        const ROOM_INVITE_URL = './api/video-room-invite.php';
        const ROOM_MEMBER_REMOVE_URL = './api/video-room-member-remove.php';
        ...
        async function mountVideoRoom() {
            ...
            try {
                ...
                updateEmptyState('ZEGO configuration required', error.message || 'The page could not build a valid ZEGO kit token.', '<a class="btn primary" href="./video-match.php">Back To Lobby</a><a class="btn" href="../Academic-Practice/training.html">Back To Training</a>');
            }
        }
