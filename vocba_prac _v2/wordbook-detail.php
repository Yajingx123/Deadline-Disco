...
if (!$book) {
  ...
  ?>
  <p style="margin-bottom:12px"><a href="<?php echo htmlspecialchars($wordbankUrl, ENT_QUOTES, 'UTF-8'); ?>" class="linkBtn" style="display:inline-flex;align-items:center;gap:6px">← All word books</a></p>
