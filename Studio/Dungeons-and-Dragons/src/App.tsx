...
export default function App() {
  ...
  const isInRun = phase !== "menu";

  return (
    <div className="app">
      <header className={`title-bar${isInRun ? " title-bar--with-top-back" : ""}`}>
        {isInRun && (
          <button type="button" className="back-to-studio-btn" onClick={backToMenu}>
            Back to Main
          </button>
        )}
      ...
      {phase === "menu" && (
        <>
          ...
          <button type="button" className="menu-back-to-studio-btn" onClick={goBackToStudio}>
            Back to Studio
          </button>
        </>
      )}
