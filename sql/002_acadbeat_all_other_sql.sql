-- Consolidated non-table SQL file: seeds, indexes, updates, and extra bootstrap data.
-- Run this after 001_acadbeat_all_create_tables.sql.

USE acadbeat;
SET NAMES utf8mb4;

-- ===== Source: 102_acadbeat_core_seed_data.sql =====
...
INSERT INTO acadbeat.forum_posts (post_id, user_id, title, content_text, view_count, comment_count, like_count, favorite_count, last_commented_at, status, is_pinned, created_at, updated_at) VALUES (1, 1, 'How should we balance AI tools and original writing in class?', 'Our seminar keeps debating where AI support becomes too much. I am curious how other students define a fair boundary between drafting support and actual authorship.

**What counts as acceptable help** in your course right now?', 184, 2, 0, 0, '2026-03-23 12:40:00', 'deleted', 0, '2026-03-22 19:10:00', '2026-04-09 15:27:23');
INSERT INTO acadbeat.forum_posts (post_id, user_id, title, content_text, view_count, comment_count, like_count, favorite_count, last_commented_at, status, is_pinned, created_at, updated_at) VALUES (2, 2, 'Need help choosing between database systems and web development electives', 'I can only keep one elective this term. The database course looks practical, but the web development studio might help my portfolio faster.

If you took either one, what was the workload really like?', 96, 1, 0, 0, '2026-03-23 11:20:00', 'deleted', 0, '2026-03-22 21:00:00', '2026-04-09 15:27:21');
INSERT INTO acadbeat.forum_posts (post_id, user_id, title, content_text, view_count, comment_count, like_count, favorite_count, last_commented_at, status, is_pinned, created_at, updated_at) VALUES (3, 1, 'Current campus wifi slowdown near the library?', 'Has anyone else noticed the campus wifi dropping near the library this week? It gets unstable right when I upload project files, and I am trying to figure out whether it is my laptop or the network itself.', 58, 0, 0, 0, null, 'deleted', 0, '2026-03-23 08:15:00', '2026-04-09 15:27:20');
INSERT INTO acadbeat.forum_posts (post_id, user_id, title, content_text, view_count, comment_count, like_count, favorite_count, last_commented_at, status, is_pinned, created_at, updated_at) VALUES (4, 3, 'What makes a forum thread genuinely useful to future students?', 'I think the best threads are not the loudest ones. The useful ones usually include context, final outcomes, and the exact steps that solved the problem.

What should every high-quality help thread include?', 121, 1, 0, 0, '2026-03-23 13:05:00', 'deleted', 0, '2026-03-23 09:30:00', '2026-04-09 15:27:18');
INSERT INTO acadbeat.forum_posts (post_id, user_id, title, content_text, view_count, comment_count, like_count, favorite_count, last_commented_at, status, is_pinned, created_at, updated_at) VALUES (5, 9, 'My Unplanned Campus Adventure That Turned Out Perfect', 'Yesterday, I decided to skip the usual study routine and explore a hidden corner of our campus. I found a quiet bench under a big old tree near the library, surrounded by green leaves and blooming flowers. I sat there with a book, listening to the gentle wind and the sound of birds chirping. Suddenly, a few classmates from my program walked by and invited me to join their impromptu picnic with snacks and cold drinks. We laughed, chatted about our recent projects, and shared stories from our hometowns. It was such a nice break from all the assignments and deadlines. Campus life isn\'t just about attending classes and finishing homework; it\'s also about these unexpected, warm moments that make the journey memorable. I left the campus with a happy heart, feeling refreshed and ready to tackle the week ahead.', 2, 0, 0, 0, null, 'active', 0, '2026-04-09 15:31:23', '2026-04-09 15:40:23');
INSERT INTO acadbeat.forum_posts (post_id, user_id, title, content_text, view_count, comment_count, like_count, favorite_count, last_commented_at, status, is_pinned, created_at, updated_at) VALUES (6, 10, 'Course Guide: DI31001 Networks and Data Communications (Junior Year, Semester 2)', '<u>This is the absolute core course for your junior year—no exaggeration. It covers the full scope of computer networks, including the 7-layer OSI model and 5-layer TCP/IP model, plus all common protocols at every layer. This is not a surface-level course; you’ll dive deep into every key concept.</u>
**Assignment Breakdown**
**Assignment 1: Network Programming (Group Project, 5 members)**
This is the earliest major assignment since your freshman year, due early in the semester. It has two submission deadlines: mid-term submission in mid-September and final submission in early October. There’s a detailed grading rubric with a long list of required features—mid-term grading uses a subset of the rubric, while final grading covers all requirements. A mid-term presentation is mandatory.
Task: Build a complete IRC (Internet Relay Chat) system on multiple virtual machines using a language of your choice (C/C++/Python, etc.). You’ll need to implement both a server-side program and a client-side bot.
Prep Work: Use two open-source projects on GitHub—miniircd (IRC server) and HexChat (IRC client)—to learn the system workflow and command syntax. You can also use them for cross-testing your own bot and server later.
**Required Skills:**
Network programming fundamentals (socket implementation, port listening, etc., with language-specific methods)
Deep understanding of IRC, especially command syntax (the professor won’t cover this in detail; refer to https://www.irchelp.org/faq/new2irc.html)
Virtual machine configuration (manual IP setup, firewall rules, etc.)', 3, 0, 1, 1, null, 'active', 0, '2026-04-09 15:35:20', '2026-04-09 15:41:54');
INSERT INTO acadbeat.forum_posts (post_id, user_id, title, content_text, view_count, comment_count, like_count, favorite_count, last_commented_at, status, is_pinned, created_at, updated_at) VALUES (7, 11, '"Tell China\'s Stories Well in English" Event Held on April 9', 'On April 9, our university successfully held the "Tell China\'s Stories Well in English" themed event, which attracted a large number of students from different majors to participate. The activity aimed to help students improve their English expression skills, deepen their understanding of Chinese culture, and cultivate their ability to spread Chinese voices to the world.
During the event, students shared vivid stories about Chinese traditional culture, modern development, campus life and personal growth in English. Some introduced the charm of intangible cultural heritage such as paper-cutting and Peking Opera, some talked about the rapid development of China\'s high-speed rail and digital technology, and others shared their own experiences of inheriting and promoting Chinese culture. The judges gave professional comments and guidance on the students\' language expression, content logic and cultural connotation, and selected excellent works for on-site display.
This activity not only provided a platform for students to practice their English, but also inspired their sense of cultural identity and mission. Many students said that through this activity, they realized the importance of telling China\'s stories well, and would take this as an opportunity to continuously improve their cross-cultural communication ability, and become a bridge for cultural exchange between China and foreign countries. The university stated that it will continue to hold similar cultural exchange activities to help students grow into talents with international vision and cultural confidence.', 5, 0, 1, 1, null, 'active', 0, '2026-04-09 15:37:27', '2026-04-09 15:41:51');
INSERT INTO acadbeat.forum_posts (post_id, user_id, title, content_text, view_count, comment_count, like_count, favorite_count, last_commented_at, status, is_pinned, created_at, updated_at) VALUES (8, 14, 'International Study Experience at DIICSU', 'Studying at DIICSU gives us a unique mix of Chinese and UK education. We enjoy small-class teaching, all-English CS courses, and resources from both CSU and the University of Dundee. Online learning offers flexibility, while in-person seminars build real communication skills. The dual-registration system broadens our international vision. I believe this model prepares us better for global tech careers. What do you think about the DIICSU international teaching style? Share your thoughts below.', 0, 0, 0, 0, null, 'active', 0, '2026-04-09 15:39:36', '2026-04-09 15:41:24');
INSERT INTO acadbeat.forum_posts (post_id, user_id, title, content_text, view_count, comment_count, like_count, favorite_count, last_commented_at, status, is_pinned, created_at, updated_at) VALUES (9, 14, 'A Cozy Afternoon at DIICSU', '**Spent the afternoon studying at the DIICSU international lounge with my course mates. **<u>The space is bright and quiet, perfect for our group discussions. We chatted about upcoming all-English lectures, shared UK learning materials from the University of Dundee portal, and took a short break with coffee. </u>Being in DIICSU means balancing heavy CS coursework with a global vibe. These small, relaxed moments make busy junior days much nicer. It’s great to study in an international environment while staying on the CSU campus.', 3, 0, 2, 2, null, 'active', 0, '2026-04-09 15:41:16', '2026-04-09 15:42:18');
INSERT INTO acadbeat.forum_posts (post_id, user_id, title, content_text, view_count, comment_count, like_count, favorite_count, last_commented_at, status, is_pinned, created_at, updated_at) VALUES (10, 12, 'Course Guide: DI31002 Software Engineering', '<u>This is another essential core course for DIICSU CS juniors, closely linked to our joint program with the University of Dundee. It covers the full software development lifecycle, including requirement analysis, design, coding, testing and maintenance, all delivered in English to match the international teaching standards.</u>

**Assignment 1 **is a 4-person group project to develop a small-scale practical software (e.g., a student management system) using Java or Python. We need to follow agile development methods and submit a detailed English project report, which must meet Dundee’s academic writing requirements.

**Assignment 2** is an individual software testing task. We will design test cases, conduct unit and integration testing, and analyze test results using tools like JUnit or Selenium. Both assignments are assessed based on the joint criteria of DIICSU and the University of Dundee, focusing on practical ability and academic rigor.', 0, 0, 0, 0, null, 'active', 0, '2026-04-09 15:43:33', '2026-04-09 15:43:37');
...
INSERT INTO acadbeat.users (user_id, username, email, password_hash, avatar_url, role, created_at, updated_at)
VALUES
(1, 'demo_student', 'demo@acadbeat.local', '$2y$12$uumz1aB0iv66KGi.uLGqhunV4/MqdzYVAKLKOvI14zJqeSaOjdRNy', null, 'user', '2026-04-09 15:06:51', '2026-04-09 15:06:51'),
(2, 'noura', 'noura@acadbeat.local', '$2y$12$uumz1aB0iv66KGi.uLGqhunV4/MqdzYVAKLKOvI14zJqeSaOjdRNy', null, 'user', '2026-04-09 15:06:51', '2026-04-09 15:06:51'),
(3, 'emily', 'emily@acadbeat.local', '$2y$12$uumz1aB0iv66KGi.uLGqhunV4/MqdzYVAKLKOvI14zJqeSaOjdRNy', null, 'user', '2026-04-09 15:06:51', '2026-04-09 15:06:51'),
(4, 'samira', 'samira@acadbeat.local', '$2y$12$uumz1aB0iv66KGi.uLGqhunV4/MqdzYVAKLKOvI14zJqeSaOjdRNy', null, 'user', '2026-04-09 15:06:51', '2026-04-09 15:06:51'),
(5, 'benjamin', 'benjamin@acadbeat.local', '$2y$12$uumz1aB0iv66KGi.uLGqhunV4/MqdzYVAKLKOvI14zJqeSaOjdRNy', null, 'user', '2026-04-09 15:06:51', '2026-04-09 15:06:51'),
(6, 'karen', 'karen@acadbeat.local', '$2y$12$uumz1aB0iv66KGi.uLGqhunV4/MqdzYVAKLKOvI14zJqeSaOjdRNy', null, 'user', '2026-04-09 15:06:51', '2026-04-09 15:06:51'),
(7, 'shu', 'shu@acadbeat.local', '$2y$12$uumz1aB0iv66KGi.uLGqhunV4/MqdzYVAKLKOvI14zJqeSaOjdRNy', null, 'user', '2026-04-09 15:06:51', '2026-04-09 15:06:51'),
(8, 'admin', 'admin@acadbeat.local', '$2y$12$XhbLl3R3gxfC/TD8.gECzugA8voSjXrHp11yHZXoH7Pm74Bno7boi', null, 'admin', '2026-04-09 15:06:51', '2026-04-09 15:06:51'),
(9, 'Zhanpeng Yang', 'zpy@acadbeat.local', '$2y$12$.tR9RRPqm6HIfXPjUBL2jO8arUoS6CF39lh4n2AVYAw.Cs09VncEu', null, 'user', '2026-04-09 15:10:36', '2026-04-09 15:10:36'),
(10, 'Jingya Xu', 'jyx@acadbeat.local', '$2y$12$6On.oo58ZLVouznGhi.EouxaSrVqdOvV4BtmUHEaCghU3lMlH/uTa', null, 'user', '2026-04-09 15:11:00', '2026-04-09 15:11:00'),
(11, 'Yiran Xu', 'xyr@acadbeat.local', '$2y$12$gh/Iw9o4FZAno0n9t6/b5ee3T2Yl9vu23sL/xaqSdZDWOOAb8euZO', null, 'user', '2026-04-09 15:11:20', '2026-04-09 15:11:20'),
(12, 'Jingyu Pan', 'jyp@acadbeat.local', '$2y$12$Fg3ym146q3mFEFhcmcqIHu2S6YfDHcY6Y2GICLGzF/X3D2XUL4rRi', null, 'user', '2026-04-09 15:11:43', '2026-04-09 15:11:43'),
(13, 'Chuling Zhao', 'clz@acadbeat.local', '$2y$12$RUK/GptEfe6AUQi/C4nfruhGOjK0qPmE5z7D3AbCSBijmSRnZVvEK', null, 'user', '2026-04-09 15:12:12', '2026-04-09 15:12:12'),
(14, 'Qihao Tang', 'qht@acadbeat.local', '$2y$12$1XT1aZbI1lrvKKSdOCHX/Oe3ojGV5RyeouCYMP3xnwbKudvl.W1p.', null, 'user', '2026-04-09 15:13:17', '2026-04-09 15:13:17'),
(15, 'Yixuan Liu', 'yxl@acadbeat.local', '$2y$12$E7jo5x923dCmCprgylya8uIiOfCk5DHINzSjvHQ3tM7Dma3Uf32cy', null, 'user', '2026-04-09 15:14:08', '2026-04-09 15:14:08');
