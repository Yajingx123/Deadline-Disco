...
{
    return '/video-chat-project/zego-call.php?room=' . rawurlencode($roomPublicId);
}
...
{
    return '/video-chat-project/zego-call.php?room=' . rawurlencode($roomPublicId) . '&invite=' . rawurlencode($inviteToken);
}
