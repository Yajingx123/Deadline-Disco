(function () {
  ...
  window.initializeAcadBeatNav = async function initializeAcadBeatNav(options = {}) {
    ...
    const academicUrl = options.academicUrl || `${basePath}gates/academic-gate.html`;
    const forumUrl = options.forumUrl || `${basePath}gates/forum-gate.html`;
    const studioUrl = options.studioUrl || `${basePath}gates/studio-gate.html`;
    const socialUrl = options.socialUrl || `${basePath}gates/social-gate.html`;
    const competitionUrl = options.competitionUrl || options.rankUrl || `${basePath}gates/competition-gate.html`;
    ...
    const technologyUrl = options.technologyUrl || (L && L.technologyUrl) || `${basePath}gates/technology-gate.html`;
